...
from transformers.trainer_utils import EvaluationStrategy, SchedulerType
...
class TrainingArguments:
    ...
    mask_learning_rate: float = field(default=5e-5, metadata={"help": "The initial learning rate for AdamW."})
